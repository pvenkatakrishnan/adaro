...
function apply(config, reader, specialization) {
                ...
                get: function () {
                    ...
                    return function (chunks, context) {
                        function onChunk(chunk) {
                            //first figure out which template to pick if specialization is needed

                            if (specialization) {
                                name = specialization.templateResolver.resolveTemplate(name, config, context);
                            }
